...
GLUI_HSlider    *spinner, *light0_spinner, *light1_spinner, *scale_spinner;
...
*/
  spinner  = glui->add_slider_to_panel( obj_panel, false, GLUI_HSLIDER_INT,
					 &segments);
...
*/
  scale_spinner = 
    glui->add_slider_to_panel( obj_panel, false, 
				GLUI_HSLIDER_FLOAT, &scale);
...
/*
    glui->add_spinner_to_panel( light0, "Intensity:", GLUI_SPINNER_FLOAT,
				...
				control_cb );
*/
    glui->add_slider_to_panel( light0, false, GLUI_HSLIDER_FLOAT,
				&light0_intensity, LIGHT0_INTENSITY_ID,
				control_cb );
...
/*
    glui->add_spinner_to_panel( light1, "Intensity:", GLUI_SPINNER_FLOAT,
				...
				control_cb );
*/
    glui->add_slider_to_panel( light1, false, GLUI_HSLIDER_FLOAT,
				&light1_intensity, LIGHT1_INTENSITY_ID,
				control_cb );
